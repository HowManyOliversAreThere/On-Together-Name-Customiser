const translations: Record<string, string> = {
  ...
  faqCharLimitA:
    "The in-game name field is limited to 40 characters, which gets used up very quickly once you start adding colour tags. If your generated code exceeds that limit, you'll need to use one of the methods from the How to Apply section above.",
  faqCantTypeQ:
  ...
  faqHowWorksA:
    "On-Together is built in Unity and uses TextMeshPro for its text rendering. TextMeshPro supports Rich Text Tags (similar to HTML) that can be embedded in text to change colours, add bold/italic, and more. This tool generates those tags for you.",
};
